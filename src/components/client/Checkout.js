...
const Checkout = () => {
    ...
    // --- STYLE UPDATE STARTS HERE ---
    return (
        <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 to-blue-50">
            <div className="flex-1 flex flex-col">
                <ToastContainer />
                <div className="flex justify-center mb-10 text-xl mt-3 lg:mt-20">Checkout</div>
                { showIframe ? (
                ...
                <Form>
                    ...
                    <button type="submit" className="visible lg:collapse fixed bottom-0 bg-blue-950 text-white text-center w-full lg:w-0 p-4 text-bold tracking-wider font-serif flex justify-center z-50">
